...
function loadAllVideosFromBackend(){
	videos=[];
	//var pagesCount=(621191/20)-1;

	 var pagesCount=(20000/20)-1;
	//var pagesCount =10;
		console.log("INITIAL PAGE COUNT "+ pagesCount);
	for (var innerpage=0;innerpage<pagesCount;innerpage++){
		...
		setTimeout(loadFunction(innerpage),innerpage*100);
	...
	try{
		...
		var req = http.get(url, function(res) {
	  		//console.log("Response Status: " + res.statusCode);
				console.log("Response to page "+ page);
	  		res.pipe(bl(function (err, data) {
	  			try{
					...
					// console.log("Added videos from page:"+that.page);
					 console.log("Videos list size:"+videos.length);
				}
				catch(error){
